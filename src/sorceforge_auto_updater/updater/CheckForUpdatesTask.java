package sorceforge_auto_updater.updater;

import javafx.concurrent.Task;
import sorceforge_auto_updater.ConfigurationManager;
...
public class CheckForUpdatesTask extends Task<String> {
    ...
    private static final String WEB_API_PATH = "https://sourceforge.net/projects/xxxxxxxxxxxxxxxx/best_release.json";
